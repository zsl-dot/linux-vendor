...
void usage(void)
{
    fprintf(stderr, "usage:\n \
        \t./uastool 1 scene            -- set sched scene!\n \
        \t./uastool 2                  -- get sched scene!\n \
        \t./uastool 3 pid main_thread  -- set ux_tags by main_thread name!\n \
        \t./uastool 4 pid              -- cancel ux_tags!\n \
        \t./uastool 5 pid              -- get ux_tags!\n \
    ");
}
